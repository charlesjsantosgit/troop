...
- 🌴 **An infinite jungle, four biomes deep** — Emerald Rainforest, Bamboo Grove,
  Flooded Wetland, and Cloud Highland, with macro lakes hundreds of metres across
  and a streamed horizon out to 672 m.
...
| ![The origin duel arena from above — log barricades, palisades, supply huts, vines and lakes under the canopy](docs/media/arena-vista.jpg) | ![First-person view down the banana gun's sights at Captain Peel, outlined in red](docs/media/duel-first-person.jpg) |
|:--:|:--:|
| *The origin duel arena — barricades, palisades, and color-coded supply huts* | *First-person duel against Captain Peel, the solo AI rival* |
...
| ![Aerial view of the Bamboo Grove biome with winding lakes](docs/media/bamboo-grove.jpg) | ![Night sky with stars, a constellation, and the moon](docs/media/night-sky.png) |
|:--:|:--:|
| *Bamboo Grove, one of four biomes — lakes carved by domain-warped noise* | *Clear nights: ~900 stars, real constellations, planets, a cratered moon* |
