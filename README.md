...
| CTRL | bike: raise and hold a controlled wheelie | wheel brakes |
...
- The motorcycle's balance is the *outcome* of counter-steering: corrected
  ...
  and an anti-loop throttle instinct shape wheelies. CTRL raises the bike to a
  sustained balance-point wheelie and sharply reduces steering while the front is raised;
