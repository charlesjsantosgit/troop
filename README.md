...
-  **Chat, admin tools, and a debug playground** — ENTER opens text chat, a
  ...
  wings made from 182 layered high-detail feathers with a gentle articulated
  wingbeat, teleports, kicks, temp-bans, and grants or revokes persistent
...
- **Riding looks and sounds right.** Each machine authors its real cushion,
  ...
  C alternates only between a centered camera directly behind the vehicle and
  the monkey's head/cockpit view; dismounting a stopped bike or Jeep preserves
  its verified parked pose instead of unloading the suspension into a bounce.
...
| mouse | free look | move the bright dot inside the flight circle; the jet pursues that bounded 30° direction, limited to 9 g / 25° AoA |
...
| C | alternate centered chase / monkey-head camera | alternate centered chase / cockpit camera |
