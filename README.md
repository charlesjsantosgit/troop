...
- 🏔️ **Kilometre vistas on three LOD tiers** — interactive 48 m chunks, a 672 m
...
- 🌦️ **A living world** — a 60-minute day/night cycle that stays synced across the
...
- 🎙️ **Proximity voice chat** — hold-T push-to-talk with a 58 m spatial radius and
...
## What's new in Beta 0.2.1.1

- Realistic terrain: rolling hills everywhere, plus ridged, snow-capped
  mountain ranges with a canopy tree line, scree fields, and permanent
  altitude snow.
- A third **skyline LOD tier** renders mountain silhouettes out to ~1.9 km —
  pre-generated from the same seed, one draw per 768 m sector, zero physics.
- Deeper, more realistic forest palette across ground, canopy, undergrowth,
  and grass; softer leaf glow; muted flower tones.
- Atmospheric aerial perspective: distant terrain now fades into the sky
  instead of a flat green fog wall.
- Leaner than before: the benchmark scene dropped from 552 to 399 draw calls
  and holds **124 FPS average** (p95 9.8 ms) at native 1600×900 on an M4.
