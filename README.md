...
## What's new in 0.3.0 — THE VEHICLE UPDATE

- **Four drivable machines, simulated for real.** Every vehicle is a rigid
  body on raycast suspension with spring/damper/bumpstop travel, a slip-curve
  tire model with load sensitivity and a friction ellipse, a torque-curve
  engine with crank inertia, a slipping clutch, and a hysteresis-managed
  gearbox — and every part of every machine is generated by code, from the
  compressing fork sliders to the articulating live axles.
  ...
  - **Fighter jet** — **700 mph** at sea level, held there by transonic wave
    drag. Real lift/AoA aerodynamics with a genuine stall, fly-by-wire that
...
- **Riding looks and sounds right.** The monkey saddles up with bar-gripping
  or stick-and-throttle poses, leans with the machine, and stows its weapon.
...
| ![The fighter jet parked on its tricycle gear, canopy and wings in profile](docs/media/fighter-jet.jpg) | ![Safari jeep, airboat, and motorcycle lined up in the debug-world vehicle yard](docs/media/vehicle-lineup.jpg) |
|:--:|:--:|
| *The fighter jet: 700 mph at sea level, real lift and stall, FBW with G/AoA limiters* | *The 0.3.0 garage — every part generated by code, down to the fork sliders* |
...
|---|---|---|
| W / S | throttle / brake — hold S at a stop to reverse (jeep) | throttle setpoint up / down |
...
| C | cycle chase / helmet / cockpit camera | same |
